...
import org.dtristu.javaocr.ocrengine.config.TesseractConfig;
...
public class OCRService {
    ...
    /**
     * 1. initializes the ocr engine and creates a temp folder
     * 2. for each image converts it to a pdf page
     * 3. merges the pages
     * 4. cleanup and saves the merged result in database
     * @param ocrTask an incoming ocrTask
    ...
    public void doTask(OCRTask ocrTask) throws Exception {
        ...
        try {
            ...
            for (String imgId : ocrTask.getRawImagesId()) {
                img = readFileToBufferedImage(imgId);
     ...
     * @param fileNamesForDel the file names inside
     */
    ...
    /**
     * reads a file from the database and converts it to a buffered image
     * @param imgId the id of the image
     * @return a BufferedImage
     * @throws Exception
     */
    public BufferedImage readFileToBufferedImage(String imgId) throws Exception {
     ...
     * @throws Exception if it fails in writing the file
     */
    ...
    /**
     * reads the ocrMode if it is set
